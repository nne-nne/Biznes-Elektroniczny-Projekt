...
#!perl
#line 29
    eval 'exec C:\Users\adaml\Documents\Biznes-Elektroniczny-Projekt\Presta\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\Users\adaml\Documents\Biznes-Elektroniczny-Projekt\Presta\perl\bin\perl.exe';
